---
title: Commodore 64 BASIC error messages
...
# Commodore 64 BASIC error messages

| Message | Code (hex, dec) | Exec address | Message | Code (hex, dec) | Exec address | ||
|---|---|---|---|---|---|---|---|
...
---
*Fonte originale: [https://sta.c64.org/cbm64baserr.html](https://sta.c64.org/cbm64baserr.html)*
