...
c64ref:
  ...
  - name: Commodore-64-intern-Buch
    author: Commodore
    description: $B248 USR-Vektor
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: USR Address Low Byte / High Byte
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: These locations contain the target address of the USR command.  They
  - name: Reference
    author: Joe Forster / STA
    description: Execution address of USR() function
  - name: 64map
    author: —
    description: USR Address ($LB,$MB)
---
