---
title: Keyboard table setup pointer
...
c64ref:
  ...
  - name: Original Source Comments
    ...
    description: Indirect for keyboard table setup
  - name: Commodore-64-intern-Buch
    author: Commodore
    description: Hier steht ein Zeiger, der auf die
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: 'Vector: Keyboard Table Setup'
  - name: Memory Map
    author: Jim Butterfield
    description: Keyboard table setup pointer
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: This location points to the address of the Operating System routine
  - name: Reference
    author: Joe Forster / STA
    description: 'Default: $EB48.'
  - name: 64'er Magazin
    author: 64'er
    description: Das Betriebssystem hat eine Routine ab Adresse 60232 (60380 beim
      VC 20), auf
  - name: 64map
    author: —
    description: 'Vector: Routine to determine Keyboard table to use based on Shift
      Key Pattern...'
---
...
### 64map (—)
Vector: Routine to determine Keyboard table to use based on Shift Key Pattern ($EB48)
