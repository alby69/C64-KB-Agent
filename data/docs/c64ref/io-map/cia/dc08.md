...
# $DC08 — Time of Day Clock (TOD) ($DC08)

## Panoramica
Il registro o area di memoria $DC08 è descritto in dettaglio di seguito.

## Dettagli Tecnici
- **Indirizzo**: `$DC08` (`56328` decimale)
- **Range**: `$DC08`-`$DC0B`
- **Dimensione**: `4 byte`
- **Permessi**: `R/W`
