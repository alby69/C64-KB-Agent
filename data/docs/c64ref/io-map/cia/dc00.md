---
title: 'Complex Interface Adapter (CIA) #1 Registers'
...
c64ref:
  ...
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: 'MOS 6526 Complex Interface Adapter (CIA) #1'
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: 7-0  Write Keyboard Column Values for
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: Locations 56320-56335 ($DC00-$DC0F) are used to communicate with
      the
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: These registers are where the actual communication with outside
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: 0    Select to read keyboard column 0.
---

# $DC00 — Complex Interface Adapter (CIA) #1 Registers ($DC00)

## Panoramica
Il registro o area di memoria $DC00 è descritto in dettaglio di seguito.

## Dettagli Tecnici
- **Indirizzo**: `$DC00` (`56320` decimale)
- **Range**: `$DC00`-`$DC0F`
- **Dimensione**: `16 byte`
- **Permessi**: `R/W`
