...
# $DC10 — CIA #1 Register Images ($DC10)

## Panoramica
Il registro o area di memoria $DC10 è descritto in dettaglio di seguito.

## Dettagli Tecnici
- **Indirizzo**: `$DC10` (`56336` decimale)
- **Range**: `$DC10`-`$DCFF`
- **Dimensione**: `240 byte`
- **Permessi**: `R/W`
