...
c64ref:
  ...
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: MOS 6566 VIDEO INTERFACE CONTROLLER (VIC)
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: Sprite 0 X Pos
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: The Video Interface Controller (VIC-II chip) is a specially designed
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: These locations determine the horizontal and vertical position at
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: Sprite 0 Horizontal Position
---

# $D000 — VIC-II Chip Registers ($D000)

## Panoramica
Il registro o area di memoria $D000 è descritto in dettaglio di seguito.

## Dettagli Tecnici
- **Indirizzo**: `$D000` (`53248` decimale)
- **Range**: `$D000`-`$D02E`
- **Dimensione**: `47 byte`
- **Permessi**: `R/W`
