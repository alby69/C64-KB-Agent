---
title: VIC Interrupt Flag Register
...
c64ref:
  ...
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: 7    Set on Any Enabled VIC IRQ Condition
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: '0    Flag:  Is the Raster Compare a possible source of an IRQ?'
---

# VICIRQ — VIC Interrupt Flag Register ($D019)

## Panoramica
Il registro o area di memoria VICIRQ è descritto in dettaglio di seguito.

## Dettagli Tecnici
- **Indirizzo**: `$D019` (`53273` decimale)
- **Range**: `$D019`
- **Dimensione**: `1 byte`
- **Permessi**: `R/W`
