---
title: Vertical Fine Scrolling and Control Register
...
c64ref:
  ...
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: '7    Raster Compare: (Bit 8) See 53266'
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: 0-2  Fine scroll display vertically by X scan lines (0-7)
---

# SCROY — Vertical Fine Scrolling and Control Register ($D011)

## Panoramica
Il registro o area di memoria SCROY è descritto in dettaglio di seguito.

## Dettagli Tecnici
- **Indirizzo**: `$D011` (`53265` decimale)
- **Range**: `$D011`
- **Dimensione**: `1 byte`
- **Permessi**: `R/W`
