---
title: VIC-II Chip Memory Control Register
...
c64ref:
  ...
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: 7-4  Video Matrix Base Address (inside VIC)
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: 0    Unused
---

# VMCSB — VIC-II Chip Memory Control Register ($D018)

## Panoramica
Il registro o area di memoria VMCSB è descritto in dettaglio di seguito.

## Dettagli Tecnici
- **Indirizzo**: `$D018` (`53272` decimale)
- **Range**: `$D018`
- **Dimensione**: `1 byte`
- **Permessi**: `R/W`
