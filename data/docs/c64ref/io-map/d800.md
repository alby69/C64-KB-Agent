...
c64ref:
  ...
  - name: C64 Programmer's Reference Guide
    author: Commodore
    description: Color RAM (Nybbles)
  - name: Mapping the Commodore 64
    author: Sheldon Leemon
    description: The normal Commodore 64 text graphics system uses a screen RAM area
      to
---
...
## Panoramica
Il registro o area di memoria $D800 è descritto in dettaglio di seguito.

## Dettagli Tecnici
- **Indirizzo**: `$D800` (`55296` decimale)
- **Range**: `$D800`-`$DBFF`
