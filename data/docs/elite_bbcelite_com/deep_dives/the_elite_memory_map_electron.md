...
Here's the memory map for Electron Elite.
  ...
  |                                   |
  +-----------------------------------+   &4ED4 = [XX21](https://elite.bbcelite.com/electron/main/variable/xx21.html)
  |                                   |
  | Main game code (ELITECO.bin)      |
  |                                   |
  +-----------------------------------+   &0D00 = [S%](https://elite.bbcelite.com/electron/main/workspace/s_per_cent_part_1_of_2.html)
  |                                   |
  | &0CF3-&0CFF unused                |
  |                                   |
  +-----------------------------------+   &0CF3
  ...
  | WP workspace                      |
  |                                   |
  +-----------------------------------+   &0BE0 = [WP](https://elite.bbcelite.com/electron/main/workspace/wp.html)
  |                                   |
  ...
  |                                   |
  +-----------------------------------+   &0900 = [K%](https://elite.bbcelite.com/electron/main/workspace/k_per_cent.html)
  |                                   |
  ...
  |                                   |
  +-----------------------------------+   &0400 = [QQ18](https://elite.bbcelite.com/electron/main/variable/qq18.html)
  |                                   |
  ...
  | T% workspace                      |
  |                                   |
  +-----------------------------------+   &0300 = [T%](https://elite.bbcelite.com/electron/main/workspace/t_per_cent.html)
  |                                   |
  ...
  |                                   |
  +-----------------------------------+   &0100 = [XX3](https://elite.bbcelite.com/electron/main/workspace/xx3.html)
  |                                   |
  | Zero page workspace               |
  |                                   |
  +-----------------------------------+   &0000 = [ZP](https://elite.bbcelite.com/electron/main/workspace/zp.html)
