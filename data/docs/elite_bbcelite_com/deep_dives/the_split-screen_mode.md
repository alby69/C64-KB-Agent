---
title: The split-screen mode in BBC Micro Elite
...
However, because of the way the interrupt system works, this needs a little tweaking, which is where the low byte of the timer comes in. In the [IRQ1](https://elite.bbcelite.com/cassette/main/subroutine/irq1.html) routine, the low byte is set to 30, to give a total timer count of 14622.
...
---
*Fonte originale: [https://elite.bbcelite.com/deep_dives/the_split-screen_mode.html](https://elite.bbcelite.com/deep_dives/the_split-screen_mode.html)*
