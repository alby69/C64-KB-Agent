---
title: The original Elite-A source files
...
There are four source discs for Angus Duggan's Elite-A, each of them packed with code and programs. This is the catalogue of the first side of the first disc:

![The contents of the source disc for Elite-A](https://elite.bbcelite.com/images/elite-a/source_disc_contents.png) 

						In this deep dive, we're going to take a quick tour through the build process and file structure, and talk about how I converted them to build on modern computers, as seen in the [accompanying repository](https://github.com/markmoxon/elite-a-source-code-bbc-micro).
...
- Docked code: a.tcode loads a.global, a.tcode_1, a.tcode_2 and a.tcode_3 to produce an interim binary called tcode, which is then concatenated with the S.T binary (which contains the ship blueprints for the ship hangar) to produce the final docked code in 1.D
...
---
*Fonte originale: [https://elite.bbcelite.com/deep_dives/elite-a_the_original_source_files.html](https://elite.bbcelite.com/deep_dives/elite-a_the_original_source_files.html)*
