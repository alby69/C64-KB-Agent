...
source_url: https://elite.bbcelite.com/hacks/flicker-free_elite/technical_information.html
...
See the [introduction](https://elite.bbcelite.com/hacks/flicker-free_elite/) to see how the two algorithms compare, side-by-side.
...
So the Electron version might not have Thargoids, suns or detailed planets, but it now has one feature that the standard BBC Micro version does not have room for: flicker-free planets. Head over to the [downloads page](https://elite.bbcelite.com/hacks/flicker-free_elite/downloads.html) to get hold of the improved version.
...
---
*Fonte originale: [https://elite.bbcelite.com/hacks/flicker-free_elite/technical_information.html](https://elite.bbcelite.com/hacks/flicker-free_elite/technical_information.html)*
