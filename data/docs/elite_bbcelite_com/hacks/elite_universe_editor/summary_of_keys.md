...
source_url: https://elite.bbcelite.com/hacks/elite_universe_editor/summary_of_keys.html
category: tool
topics:
- basic
- assembly
...
The Universe Editor is described in full detail in the instructions for the [BBC version](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_bbc.html) and [Commodore 64 version](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_commodore_64.html), but here's a summary of all supported key presses for reference. Click on the following to jump down to the relevant section:
...
Next up are the keys for [adding, selecting, duplicating and deleting objects](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_bbc.html#adding):
...
These are the keys for [moving objects in space](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_bbc.html#moving):
...
These are the keys for [editing ship attributes](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_bbc.html#attributes):
...
And finally, these are the keys for [editing the galaxy seeds](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_bbc.html#seeds):
...
Next up are the keys for [adding, selecting, duplicating and deleting objects](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_commodore_64.html#adding):
...
These are the keys for [moving objects in space](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_commodore_64.html#moving):
...
These are the keys for [editing ship attributes](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_commodore_64.html#attributes):
...
And finally, these are the keys for [editing the galaxy seeds](https://elite.bbcelite.com/hacks/elite_universe_editor/instructions_commodore_64.html#seeds):
...
---
*Fonte originale: [https://elite.bbcelite.com/hacks/elite_universe_editor/summary_of_keys.html](https://elite.bbcelite.com/hacks/elite_universe_editor/summary_of_keys.html)*
