...
Finally, Ian Stocks has written a very cool version of the scoreboard for the Acorn Atom, which you can download from the [installation page](https://elite.bbcelite.com/elite_over_econet_installing.html). So while there isn't a version of Econet Elite for the Atom, it's still possible to include all the core Acorn machines into your multiplayer Elite tournament: Atom, BBC Micro, Electron, BBC Master, Archimedes and Risc PC.
...
7. To configure Archimedes Elite to send scores to the scoreboard, you need to be running version 1.14 of Archimedes Elite, which you can [download from archive.org](https://web.archive.org/web/20060130144818/http://phlamethrower.co.uk/riscos/elite.zip) . You will also need the EliteNet application, which you can download from the page on[installing Elite over Econet](https://elite.bbcelite.com/elite_over_econet_installing.html) . For instructions on how to use EliteNet, click Menu on the application icon in the Filer and choose Help from the App. '!EliteNet' submenu.
...
---
*Fonte originale: [https://elite.bbcelite.com/hacks/elite_over_econet_scoreboard.html](https://elite.bbcelite.com/hacks/elite_over_econet_scoreboard.html)*
