---
title: Technical information for BBC Micro disc Elite on the Acorn Electron
source_url: https://elite.bbcelite.com/hacks/acorn_electron_disc_elite/technical_information.html
...
If you want to see exactly how the code for the disc version of Electron Elite differs from the code in the original Acornsoft version, you can check out the relevant branches in the project repository:
...
For the disc version of Electron Elite, I've moved all speed-critical code and variables into sideways RAM. I've left zero page alone, as although it is accessed at 1MHz, the 6502's faster and smaller zero-page instructions cancel out any advantage of moving zero page variables into sideways RAM.
...
With the exception of the four-colour dashboard, Electron players can now enjoy everything that the BBC Micro had back in 1984. Here's a complete list of features I've added to the disc version of Electron Elite, and below that is a blow-by-blow comparison between the various versions.
...
As well as the list above, BBC Micro disc Elite on the Acorn Electron has the following Compendium-specific features:
...
Read [about the Elite Compendium](https://elite.bbcelite.com/hacks/elite_compendium) for more information on these extra features.

---
*Fonte originale: [https://elite.bbcelite.com/hacks/acorn_electron_disc_elite/technical_information.html](https://elite.bbcelite.com/hacks/acorn_electron_disc_elite/technical_information.html)*
