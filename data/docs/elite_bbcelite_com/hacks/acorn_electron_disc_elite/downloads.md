---
title: Playing BBC Micro disc Elite on the Acorn Electron
source_url: https://elite.bbcelite.com/hacks/acorn_electron_disc_elite/downloads.html
category: reference
topics:
- basic
- assembly
...
# Playing BBC Micro disc Elite on the Acorn Electron

## How to download and play the improved version of Acorn Electron Elite

The [Elite Compendium](https://elite.bbcelite.com/hacks/elite_compendium) is the best way to enjoy BBC Micro disc Elite on the Acorn Electron, in combination with my other hacks - see the [download page](https://elite.bbcelite.com/hacks/elite_compendium/downloads.html) for details.

This page looks at the requirements for running BBC Micro disc Elite on the Acorn Electron.
...
If your user port interface only has one user port, then choosing port B is probably the correct option (though there's no harm in trying both). See [playing the Elite Compendium](https://elite.bbcelite.com/hacks/elite_compendium/downloads.html) for more details about Delta 14B support.
...
BBC Micro disc Elite on the Acorn Electron has had the following releases:
...
---
*Fonte originale: [https://elite.bbcelite.com/hacks/acorn_electron_disc_elite/downloads.html](https://elite.bbcelite.com/hacks/acorn_electron_disc_elite/downloads.html)*
