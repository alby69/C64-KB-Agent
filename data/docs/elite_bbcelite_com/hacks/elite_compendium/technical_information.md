...
source_url: https://elite.bbcelite.com/hacks/elite_compendium/technical_information.html
...
The BBC Master is known for its flicker-free ships when compared to earlier versions of Elite. The improved algorithm gives much smoother ship-drawing, and it's such a simple fix that it was the first Elite hack that I backported, and is still one of the best (see the [flicker-free hack](https://elite.bbcelite.com/hacks/flicker-free_elite/technical_information.html) for more information).
...
---
*Fonte originale: [https://elite.bbcelite.com/hacks/elite_compendium/technical_information.html](https://elite.bbcelite.com/hacks/elite_compendium/technical_information.html)*
