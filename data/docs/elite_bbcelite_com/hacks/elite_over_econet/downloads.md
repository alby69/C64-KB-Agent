...
source_url: https://elite.bbcelite.com/hacks/elite_over_econet/downloads.html
category: reference
topics:
- basic
- assembly
...
For details of how to download and install Elite over Econet for the 8-bit machines on your own network (i.e. the BBC Micro, BBC Master and Acorn Electron), see the instructions for [installing Elite over Econet](https://elite.bbcelite.com/hacks/elite_over_econet/installing.html).

For more information about the 32-bit version, see [Elite over Econet on the Acorn Archimedes](https://elite.bbcelite.com/hacks/elite_over_econet/acorn_archimedes.html).
...
See [the Elite multiplayer scoreboard](https://elite.bbcelite.com/hacks/elite_over_econet/scoreboard.html) for more details on multiplayer games.
...
---
*Fonte originale: [https://elite.bbcelite.com/hacks/elite_over_econet/downloads.html](https://elite.bbcelite.com/hacks/elite_over_econet/downloads.html)*
