...
source_url: https://elite.bbcelite.com/hacks/elite_over_econet/installing.html
category: manual
topics:
- basic
- assembly
...
To play Elite on your Econet network, you'll either need a PiEconetBridge with access to the TNMoC Econet Cloud (see [playing Elite over Econet](https://elite.bbcelite.com/hacks/elite_over_econet/downloads.html) for details), or you'll need to install the game on your own Econet fileserver by choosing one of these options and following the instructions below (they both contain the same files, so choose the one that's easiest to install on your network):
...
The game is now installed - see the section on [playing Elite over Econet](https://elite.bbcelite.com/hacks/elite_over_econet/downloads.html#playing) for details on how to run the game.
...
---
*Fonte originale: [https://elite.bbcelite.com/hacks/elite_over_econet/installing.html](https://elite.bbcelite.com/hacks/elite_over_econet/installing.html)*
