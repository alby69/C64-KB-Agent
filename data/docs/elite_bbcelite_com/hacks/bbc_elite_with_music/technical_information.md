...
source_url: https://elite.bbcelite.com/hacks/bbc_elite_with_music/technical_information.html
...
The idea to use Simon's player in Elite was down to Kieran Connell; he was also the inspiration for [Teletext Elite](https://elite.bbcelite.com/hacks/teletext_elite/) and [Elite 3D](https://elite.bbcelite.com/hacks/elite_3d/), and it was Kieran who [got me into disassembling Elite in the first place](https://elite.bbcelite.com/about_site/about_this_project.html), so he has form! After we had a quick chat about what might be possible, Kieran refactored Simon's player to work in sideways RAM, as there is simply no spare memory when Elite is running, so sideways RAM is the only viable option for storing the music (see the deep dive on the [Elite memory map](https://elite.bbcelite.com/deep_dives/the_elite_memory_map.html) to see what I mean).
...
---
*Fonte originale: [https://elite.bbcelite.com/hacks/bbc_elite_with_music/technical_information.html](https://elite.bbcelite.com/hacks/bbc_elite_with_music/technical_information.html)*
