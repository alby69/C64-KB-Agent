...
- From the “Learning ML” series by Craig Bruce, in C= Hacking:
  - [Learning ML 4](https://codebase.c64.org/doku.php?id=magazines:chacking4#learning_machine_language_-_part_4) - Development of a Space Invaders game (for the 64 and 128), part 1

- From the “Rants” series by Cadaver/Covert BitOps
  - [Multidirectional scrolling and the "game world"](https://codebase.c64.org/doku.php?id=base:rant4) - aka["Rant 4"](http://cadaver.homeftp.net/rants/scroll.htm) - article by Cadaver
...
- Graphic effects
  - [Static starfield](https://codebase.c64.org/doku.php?id=base:static_starfield) - by Achim
