---
title: Optimal Sort for any number of 16-bit elements
source_url: https://codebase.c64.org/doku.php?id=base%3Aoptimal_sort_16-bit_elements
category: reference
topics:
- sprite programming
- assembly
...
- **`L1`** (unknown): No description available
...
#### Routine Identificate:
- **`SORT`** (unknown): No description available
- **`LER`** (unknown): No description available
- **`L0`** (unknown): No description available
- **`L1`** (unknown): No description available
- **`L1A`** (unknown): No description available
- **`L1B`** (unknown): No description available
- **`L2`** (unknown): No description available
- **`L3`** (unknown): No description available
- **`L3A`** (unknown): No description available
- **`L3B`** (unknown): No description available
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Aoptimal_sort_16-bit_elements](https://codebase.c64.org/doku.php?id=base%3Aoptimal_sort_16-bit_elements)*
