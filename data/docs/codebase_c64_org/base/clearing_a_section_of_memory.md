---
title: Clearing a Section of Memory
...
- **`CLRMEM`** (unknown): No description available
- **`CLRM1`** (unknown): No description available
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Aclearing_a_section_of_memory](https://codebase.c64.org/doku.php?id=base%3Aclearing_a_section_of_memory)*
