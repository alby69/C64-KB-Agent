...
```
base/kernalreference.txt · Last modified:  by 127.0.0.1
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Akernalreference](https://codebase.c64.org/doku.php?id=base%3Akernalreference)*
