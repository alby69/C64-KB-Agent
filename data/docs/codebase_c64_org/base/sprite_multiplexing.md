---
title: Sprite multiplexing by Cadaver
...
(This rant is mirrored from [Cadavers site](http://cadaver.homeftp.net/))
...
[An example general multiplexer](http://covertbitops.c64.org/rants/multi.zip)
...
[Metal Warrior 3 source code](http://covertbitops.c64.org/games/mw3src.zip)
(doublebuffering, inaccurate “Y divided by 8” sorting, precalculation of raster
interrupts)

[The Freedirectional Scrolling test program](http://covertbitops.c64.org/rants/freedir.zip)
(doublebuffering, radix sorting of Y-coords)

[BOFH source code](http://covertbitops.c64.org/games/bofhsrc.zip)
...
- **`sortloop`** (unknown): No description available
- **`sortswap`** (unknown): No description available
- **`sortreload`** (unknown): No description available
- **`sortskip`** (unknown): No description available
...
#### Routine Identificate:
- **`msb_high`** (unknown): No description available
- **`msb_low`** (unknown): No description available
- **`nextsprite`** (unknown): No description available
- **`ortbl`** (unknown): No description available
- **`andtbl`** (unknown): No description available
...
#### Routine Identificate:
- **`sprite0`** (unknown): No description available
- **`frame0`** (unknown): No description available
- **`sprite1`** (unknown): No description available
- **`frame1`** (unknown): No description available
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Asprite_multiplexing](https://codebase.c64.org/doku.php?id=base%3Asprite_multiplexing)*
