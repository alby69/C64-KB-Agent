---
title: Double IRQ stable interrupt
...
text1
         ...
         .text "dify this code :)"
```
base/double_irq.txt · Last modified:  by 127.0.0.1
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Adouble_irq](https://codebase.c64.org/doku.php?id=base%3Adouble_irq)*
