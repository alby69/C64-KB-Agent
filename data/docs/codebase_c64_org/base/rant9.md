---
title: Frameskipping, interpolation and re-entrant IRQ code by Cadaver
source_url: https://codebase.c64.org/doku.php?id=base%3Arant9
...
- For rendering the internal state onscreen. On C64, this means things like scrolling (shifting the screen memory if no VIC tricks are used), sorting the sprites for multiplexing, and actually showing the multiplexed sprites.
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Arant9](https://codebase.c64.org/doku.php?id=base%3Arant9)*
