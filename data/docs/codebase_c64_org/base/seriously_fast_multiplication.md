---
title: Seriously fast multiplication (8-bit and 16-bit)
source_url: https://codebase.c64.org/doku.php?id=base%3Aseriously_fast_multiplication
category: reference
topics:
- assembly
...
base:seriously_fast_multiplication

                # Seriously fast multiplication (8-bit and 16-bit)

By Jackasser

Without further explanation here's the code for really fast multiplications. They require 2k of tables which can be generated using [table_generator_routine_for_fast_8_bit_mul_table](https://codebase.c64.org/doku.php?id=base:table_generator_routine_for_fast_8_bit_mul_table). The article from C=Hacking 16 which is mentioned in the source is available [here](https://codebase.c64.org/doku.php?id=magazines:chacking16#d_graphics_for_the_masseslib3d_and_cool_world).
...
.endproc
```
base/seriously_fast_multiplication.txt · Last modified:  by 127.0.0.1
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Aseriously_fast_multiplication](https://codebase.c64.org/doku.php?id=base%3Aseriously_fast_multiplication)*
