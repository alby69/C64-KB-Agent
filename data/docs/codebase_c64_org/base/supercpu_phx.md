---
title: PHX
source_url: https://codebase.c64.org/doku.php?id=base%3Asupercpu_phx
category: reference
topics:
- sprite programming
- assembly
...
```
    ...
    Flags Affected:
        N/A
    Description:
        Push the contents of the X index register onto the stack. The register
        itself is unchanged.
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Asupercpu_phx](https://codebase.c64.org/doku.php?id=base%3Asupercpu_phx)*
