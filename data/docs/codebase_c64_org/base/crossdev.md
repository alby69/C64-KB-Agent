...
- Kick Assembler development with[Sublime Text 3](http://www.sublimetext.com/3) :
  - Sublime Package (Package control):[Kick Assembler (C64)](<https://sublime.wbond.net/packages/Kick%20Assembler%20(C64)>)
