---
title: Sample wedge - Adding four new BASIC commands
...
Code written by Scott Julian. Added to Codebase by Frantic.

This source adds four new commands to the set of BASIC commands, to give you an idea how to add your own commands to the BASIC wedge. This can be useful when making your own auto-starting [cartridge ROM software](https://codebase.c64.org/doku.php?id=base:thirdparty#cartridges) for example. The source code is well commented and quite short so it should be easy to follow as is.
...
```
base/basicwedge.txt · Last modified:  by 127.0.0.1
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Abasicwedge](https://codebase.c64.org/doku.php?id=base%3Abasicwedge)*
