---
title: Sound Fx Player
source_url: https://codebase.c64.org/doku.php?id=base%3Asound_fx_player
category: reference
topics:
- sound generation
- raster interrupts
...
iwrite
	...
	.byte 1
```
base/sound_fx_player.txt · Last modified:  by 127.0.0.1
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Asound_fx_player](https://codebase.c64.org/doku.php?id=base%3Asound_fx_player)*
