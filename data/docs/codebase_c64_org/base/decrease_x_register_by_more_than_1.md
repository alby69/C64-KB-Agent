...
1. AND X with A and put result in X
2. Subtract VALUE from X as if carry flag was set (but it doesn't matter if it's really set or not) and store result in X.
