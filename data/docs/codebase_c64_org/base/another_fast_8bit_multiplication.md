---
title: Fast 8bit * 8bit = 16bit multiply
source_url: https://codebase.c64.org/doku.php?id=base%3Aanother_fast_8bit_multiplication
category: reference
topics:
- assembly
...
; Input variables:
;   AC (multiplicand)
;   fac (multiplier), should be at zeropage for speed
; Used variables:
;   AC, XR and YR
...
---
*Fonte originale: [https://codebase.c64.org/doku.php?id=base%3Aanother_fast_8bit_multiplication](https://codebase.c64.org/doku.php?id=base%3Aanother_fast_8bit_multiplication)*
