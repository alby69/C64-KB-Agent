...
 
  ...
  public [String](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+string) name ();
 
...
 
  static final int HASH =
      (int) [Math](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+math).ceil ( (double) consts.MAXVALUE / (double) BUCKETS);
 
...
 
    if (consts.MAXVALUE >= MARKER) {
      throw new [RuntimeException](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+runtimeexception) ("Internal error (MAXVALUE is too large)");
    }
 
  }
 
...
 
    throw new [RuntimeException](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+runtimeexception) ("Internal error");
 
  }
 
}
...
 
    for (int i = 0; i < consts.MAXSPRITES; i++) {
      Sprite[i].y = (int) ([Math](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+math).random () * consts.MAXVALUE);
    }
 
  }
 
...
 
    for (int i = 0; i < consts.MAXSPRITES; i++) {
      Sprite[i].y = (i *
                    (int) [Math](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+math).ceil ( (double) consts.MAXVALUE /
...
 
    for (int i = 0; i < consts.MAXSPRITES; i++) {
      Sprite[i].gamePatternIndex = (int) ([Math](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+math).random () *
                                   gamePatternY.length);
    }
 
  }
...
 
      ...
      sort.sort ();
 
      [ArrayList](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+arraylist) originalList = new [ArrayList](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+arraylist) ();
      [ArrayList](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+arraylist) sortedList = new [ArrayList](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+arraylist) ();
 
      for (int i = 0; i < consts.MAXSPRITES; i++) {
        originalList.add (new [Integer](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+integer) (sManager.Sprite[i].y));
      }
 
      int minY = 0;
      int curY;
...
 
        ...
        sortedList.add (new [Integer](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+integer) (curY));
 
        if (curY >= minY) {
          minY = curY;
        }
        else {
          throw new [RuntimeException](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+runtimeexception) ("Sort order malfunction");
        }
 
      }
 
      if (!sortedList.containsAll (originalList)) {
        throw new [RuntimeException](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+runtimeexception) ("Sort did not return all added elements");
      }
 
    }
 
...
 
  public void run () {
 
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Sorting " + consts.MAXSPRITES + " sprites in " +
        MAXTESTITERATIONS + " test runs for the << " + sort.name () +
        " >> sorting method");
 
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Running the functional test");
    functionalTest ();
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Functional test completed succesfully");
 
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Completely random Y");
    long start = [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).currentTimeMillis ();
    randomYSort ();
    long stop = [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).currentTimeMillis ();
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Elapsed: " + (stop - start));
 
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Extremes of Y");
    start = [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).currentTimeMillis ();
    extremesOfYSort ();
    stop = [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).currentTimeMillis ();
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Elapsed: " + (stop - start));
 
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Gaming pattern Y");
    start = [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).currentTimeMillis ();
    gamePatternYSort ();
    stop = [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).currentTimeMillis ();
    [System](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+system).out.println ("Elapsed: " + (stop - start));
...
 
  // main entry point
 
  public static void main ([String](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+string)[] args) throws [Exception](http://www.google.com/search?hl=en&q=allinurl%3Adocs.oracle.com+javase+docs+api+exception) {
 
