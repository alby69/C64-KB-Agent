...
 
    ...
    r = 0x20;
    for (a = 0; a < degrees; a++) {
        result[a + 0x000] = round([sin](http://www.opengroup.org/onlinepubs/009695399/functions/sin.html)(2.0 * PI * a / (float)degrees) * r);
        result[a + 0x100] = round([cos](http://www.opengroup.org/onlinepubs/009695399/functions/cos.html)(2.0 * PI * a / (float)degrees) * r);
    }
 
...
 
    fw = [fopen](http://www.opengroup.org/onlinepubs/009695399/functions/fopen.html)("sinus.bin", "wb");
    [fwrite](http://www.opengroup.org/onlinepubs/009695399/functions/fwrite.html)(&result[0], 1, 0xb00, fw);
    [fclose](http://www.opengroup.org/onlinepubs/009695399/functions/fclose.html)(fw);
}
